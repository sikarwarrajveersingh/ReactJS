...
const RightCardContent = (props) => {
  return (
    <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
        ...
        <p className='text-xl leading-normal text-white mb-1 mt-15'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fugiat excepturi quam nemo exercitationem, neque fuga.</p>
